...
def _print_summary(logistic_results: dict, xgb_results: dict) -> None:
    ...
    print(f"\n  {'Metric':<20s} {'Logistic':>10s} {'XGBoost':>10s}")
    print(f"  {'-' * 42}")
    for key in ("auroc", "pr_auc", "sensitivity", "specificity", "f1"):
        print(f"  {key:<20s} {lr_m[key]:>10.4f} {xgb_m[key]:>10.4f}")
